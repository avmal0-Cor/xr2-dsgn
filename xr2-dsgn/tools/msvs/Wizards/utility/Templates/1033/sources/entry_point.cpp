...
static xray::uninitialized_reference<xray::[!output PROJECT_NAME]::application>	s_application;
...
struct guard {
	inline	guard				( )
	{
		XRAY_CONSTRUCT_REFERENCE( s_application, xray::[!output PROJECT_NAME]::application );
