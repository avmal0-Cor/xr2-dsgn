...
_FUNC_DEF(vec_float4, logf4, (vec_float4 x)) 
{
  ...
  vec_float4 polywneg;
  polywneg = vec_madd((vec_float4)(_LOGF_H_c0), w, (vec_float4)(_LOGF_H_c1));
  polywneg = vec_madd(polywneg                , w, (vec_float4)(_LOGF_H_c2));

  vec_float4 y    = vec_madd(z, vec_madd(polywneg, w, x1), vzero);
  vec_float4 wnew = vec_ctf(xexp,0);
  vec_float4 zz1     = vec_madd((vec_float4)(_LOGF_H_ln2msb)   , wnew, x1);
  vec_float4 zz2neg  = vec_madd((vec_float4)(_LOGF_H_negln2lsb), wnew, y );
