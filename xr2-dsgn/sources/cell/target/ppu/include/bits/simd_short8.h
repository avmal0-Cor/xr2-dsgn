...
{
   short tmp = (short)rhs;
   data = __extension__ (vec_short8){ tmp, tmp, tmp, tmp, tmp, tmp, tmp, tmp };
}
...
{
   data = (vec_short8)vec_and( (vec_ushort8)rhs, (vec_ushort8)(1) );
}
...
{
   return (short)_vec_extract((vec_short8)data, i);
}
...
{
   return short8( vec_nor( data, data ) );
}
...
short8::operator - () const
{
   return short8( (vec_short8)vec_sub( (vec_short8)(0), data ) );
}
...
{
   return short8( vec_mladd( (vec_short8)lhs, (vec_short8)rhs, (vec_short8)(0) ) );
}
...
operator + ( short8 lhs, short8 rhs )
{
   return short8( vec_add( (vec_short8)lhs, (vec_short8)rhs ) );
}
...
operator - ( short8 lhs, short8 rhs )
{
   return short8( vec_sub( (vec_short8)lhs, (vec_short8)rhs ) );
}
...
{
   return short8( vec_sl( (vec_short8)lhs, (vec_ushort8)rhs ) );
}
...
operator >> ( short8 lhs, ushort8 rhs )
{
   return short8( vec_sra( (vec_short8)lhs, (vec_ushort8)rhs ) );
}
...
{
   bool8 result;
   result.data = (vec_ushort8)vec_cmpgt( (vec_short8)rhs, (vec_short8)lhs );
   return result;
}
...
{
   bool8 result;
   result.data = (vec_ushort8)vec_cmpgt( (vec_short8)lhs, (vec_short8)rhs );
   return result;
}
...
{
   bool8 result;
   result.data = (vec_ushort8)vec_cmpeq( (vec_short8)lhs, (vec_short8)rhs );
   return result;
}
...
{
   return short8( vec_sel( (vec_short8)lhs, (vec_short8)rhs, (vec_ushort8)rhs_slots ) );
}
...
operator & ( short8 lhs, short8 rhs )
{
   return short8( vec_and( (vec_short8)lhs, (vec_short8)rhs ) );
}
...
operator | ( short8 lhs, short8 rhs )
{
   return short8( vec_or( (vec_short8)lhs, (vec_short8)rhs ) );
}
...
operator ^ ( short8 lhs, short8 rhs )
{
   return short8( vec_xor( (vec_short8)lhs, (vec_short8)rhs ) );
}
   
inline
short8_idx::operator short() const
{ 
   return (short)_vec_extract( (vec_short8)ref, i );
}
...
{
   ref = _vec_insert( (short)rhs, (vec_short8)ref, i );
   return rhs;
}
...
{
   short tmp = _vec_extract( (vec_short8)ref, i );
   ref = _vec_insert( tmp+1, (vec_short8)ref, i );
   return tmp;
}
...
short8_idx::operator ++()
{
   short tmp = _vec_extract( (vec_short8)ref, i );
   ++tmp;
   ref = _vec_insert( tmp, (vec_short8)ref, i );
   return tmp;
}
...
short8_idx::operator *= ( short rhs )
{
   short tmp = _vec_extract( (vec_short8)ref, i ) * rhs;
   ref = _vec_insert( tmp, (vec_short8)ref, i );
   return tmp;
}
