...
{
    vmathSoaQMakeFromElems( result, (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(1.0f) );
}
...
static inline void vmathSoaQSlerp( VmathSoaQuat *result, vec_float4 t, const VmathSoaQuat *unitQuat0, const VmathSoaQuat *unitQuat1 )
{
    ...
    scale0 = vec_sel( vec_sub( (vec_float4)(1.0f), t ), vec_madd( sinf4( vec_madd( vec_sub( (vec_float4)(1.0f), t ), angle, (vec_float4)(0.0f) ) ), recipSinAngle, (vec_float4)(0.0f) ), selectMask );
    scale1 = vec_sel( t, vec_madd( sinf4( vec_madd( t, angle, (vec_float4)(0.0f) ) ), recipSinAngle, (vec_float4)(0.0f) ), selectMask );
...
static inline void vmathSoaQSquad( VmathSoaQuat *result, vec_float4 t, const VmathSoaQuat *unitQuat0, const VmathSoaQuat *unitQuat1, const VmathSoaQuat *unitQuat2, const VmathSoaQuat *unitQuat3 )
{
    ...
    vmathSoaQSlerp( result, vec_madd( vec_madd( (vec_float4)(2.0f), t, (vec_float4)(0.0f) ), vec_sub( (vec_float4)(1.0f), t ), (vec_float4)(0.0f) ), &tmp0, &tmp1 );
}
...
{
    result->x = vec_madd( quat->x, scalar, (vec_float4)(0.0f) );
    result->y = vec_madd( quat->y, scalar, (vec_float4)(0.0f) );
    result->z = vec_madd( quat->z, scalar, (vec_float4)(0.0f) );
    result->w = vec_madd( quat->w, scalar, (vec_float4)(0.0f) );
}
...
{
    vec_float4 result;
    result = vec_madd( quat0->x, quat1->x, (vec_float4)(0.0f) );
    result = vec_add( result, vec_madd( quat0->y, quat1->y, (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( quat0->z, quat1->z, (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( quat0->w, quat1->w, (vec_float4)(0.0f) ) );
    return result;
}
...
{
    vec_float4 result;
    result = vec_madd( quat->x, quat->x, (vec_float4)(0.0f) );
    result = vec_add( result, vec_madd( quat->y, quat->y, (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( quat->z, quat->z, (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( quat->w, quat->w, (vec_float4)(0.0f) ) );
    return result;
}
...
static inline void vmathSoaQNormalize( VmathSoaQuat *result, const VmathSoaQuat *quat )
{
    ...
    result->x = vec_madd( quat->x, lenInv, (vec_float4)(0.0f) );
    result->y = vec_madd( quat->y, lenInv, (vec_float4)(0.0f) );
    result->z = vec_madd( quat->z, lenInv, (vec_float4)(0.0f) );
    result->w = vec_madd( quat->w, lenInv, (vec_float4)(0.0f) );
}
...
static inline void vmathSoaQMakeRotationArc( VmathSoaQuat *result, const VmathSoaVector3 *unitVec0, const VmathSoaVector3 *unitVec1 )
{
    ...
    cosHalfAngleX2 = sqrtf4( vec_madd( (vec_float4)(2.0f), vec_add( (vec_float4)(1.0f), vmathSoaV3Dot( unitVec0, unitVec1 ) ), (vec_float4)(0.0f) ) );
    ...
    vmathSoaQMakeFromV3Scalar( result, &tmpV3_1, vec_madd( cosHalfAngleX2, (vec_float4)(0.5f), (vec_float4)(0.0f) ) );
}
...
static inline void vmathSoaQMakeRotationAxis( VmathSoaQuat *result, vec_float4 radians, const VmathSoaVector3 *unitVec )
{
    ...
    angle = vec_madd( radians, (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
...
static inline void vmathSoaQMakeRotationX( VmathSoaQuat *result, vec_float4 radians )
{
    ...
    angle = vec_madd( radians, (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    vmathSoaQMakeFromElems( result, s, (vec_float4)(0.0f), (vec_float4)(0.0f), c );
}
...
static inline void vmathSoaQMakeRotationY( VmathSoaQuat *result, vec_float4 radians )
{
    ...
    angle = vec_madd( radians, (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    vmathSoaQMakeFromElems( result, (vec_float4)(0.0f), s, (vec_float4)(0.0f), c );
}
...
static inline void vmathSoaQMakeRotationZ( VmathSoaQuat *result, vec_float4 radians )
{
    ...
    angle = vec_madd( radians, (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    vmathSoaQMakeFromElems( result, (vec_float4)(0.0f), (vec_float4)(0.0f), s, c );
}
...
static inline void vmathSoaQMul( VmathSoaQuat *result, const VmathSoaQuat *quat0, const VmathSoaQuat *quat1 )
{
    ...
    tmpX = vec_sub( vec_add( vec_add( vec_madd( quat0->w, quat1->x, (vec_float4)(0.0f) ), vec_madd( quat0->x, quat1->w, (vec_float4)(0.0f) ) ), vec_madd( quat0->y, quat1->z, (vec_float4)(0.0f) ) ), vec_madd( quat0->z, quat1->y, (vec_float4)(0.0f) ) );
    tmpY = vec_sub( vec_add( vec_add( vec_madd( quat0->w, quat1->y, (vec_float4)(0.0f) ), vec_madd( quat0->y, quat1->w, (vec_float4)(0.0f) ) ), vec_madd( quat0->z, quat1->x, (vec_float4)(0.0f) ) ), vec_madd( quat0->x, quat1->z, (vec_float4)(0.0f) ) );
    tmpZ = vec_sub( vec_add( vec_add( vec_madd( quat0->w, quat1->z, (vec_float4)(0.0f) ), vec_madd( quat0->z, quat1->w, (vec_float4)(0.0f) ) ), vec_madd( quat0->x, quat1->y, (vec_float4)(0.0f) ) ), vec_madd( quat0->y, quat1->x, (vec_float4)(0.0f) ) );
    tmpW = vec_sub( vec_sub( vec_sub( vec_madd( quat0->w, quat1->w, (vec_float4)(0.0f) ), vec_madd( quat0->x, quat1->x, (vec_float4)(0.0f) ) ), vec_madd( quat0->y, quat1->y, (vec_float4)(0.0f) ) ), vec_madd( quat0->z, quat1->z, (vec_float4)(0.0f) ) );
...
{
    vec_float4 tmpX, tmpY, tmpZ, tmpW;
    tmpX = vec_sub( vec_add( vec_madd( quat->w, vec->x, (vec_float4)(0.0f) ), vec_madd( quat->y, vec->z, (vec_float4)(0.0f) ) ), vec_madd( quat->z, vec->y, (vec_float4)(0.0f) ) );
    tmpY = vec_sub( vec_add( vec_madd( quat->w, vec->y, (vec_float4)(0.0f) ), vec_madd( quat->z, vec->x, (vec_float4)(0.0f) ) ), vec_madd( quat->x, vec->z, (vec_float4)(0.0f) ) );
    tmpZ = vec_sub( vec_add( vec_madd( quat->w, vec->z, (vec_float4)(0.0f) ), vec_madd( quat->x, vec->y, (vec_float4)(0.0f) ) ), vec_madd( quat->y, vec->x, (vec_float4)(0.0f) ) );
    tmpW = vec_add( vec_add( vec_madd( quat->x, vec->x, (vec_float4)(0.0f) ), vec_madd( quat->y, vec->y, (vec_float4)(0.0f) ) ), vec_madd( quat->z, vec->z, (vec_float4)(0.0f) ) );
    result->x = vec_add( vec_sub( vec_add( vec_madd( tmpW, quat->x, (vec_float4)(0.0f) ), vec_madd( tmpX, quat->w, (vec_float4)(0.0f) ) ), vec_madd( tmpY, quat->z, (vec_float4)(0.0f) ) ), vec_madd( tmpZ, quat->y, (vec_float4)(0.0f) ) );
    result->y = vec_add( vec_sub( vec_add( vec_madd( tmpW, quat->y, (vec_float4)(0.0f) ), vec_madd( tmpY, quat->w, (vec_float4)(0.0f) ) ), vec_madd( tmpZ, quat->x, (vec_float4)(0.0f) ) ), vec_madd( tmpX, quat->z, (vec_float4)(0.0f) ) );
    result->z = vec_add( vec_sub( vec_add( vec_madd( tmpW, quat->z, (vec_float4)(0.0f) ), vec_madd( tmpZ, quat->w, (vec_float4)(0.0f) ) ), vec_madd( tmpX, quat->y, (vec_float4)(0.0f) ) ), vec_madd( tmpY, quat->x, (vec_float4)(0.0f) ) );
}
