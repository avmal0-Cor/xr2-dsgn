...
static inline void vmathSoaM3MakeFromQ( VmathSoaMatrix3 *result, const VmathSoaQuat *unitQuat )
{
    ...
    qy2 = vec_add( qy, qy );
    qz2 = vec_add( qz, qz );
    qxqx2 = vec_madd( qx, qx2, (vec_float4)(0.0f) );
    qxqy2 = vec_madd( qx, qy2, (vec_float4)(0.0f) );
    qxqz2 = vec_madd( qx, qz2, (vec_float4)(0.0f) );
    qxqw2 = vec_madd( qw, qx2, (vec_float4)(0.0f) );
    qyqy2 = vec_madd( qy, qy2, (vec_float4)(0.0f) );
    qyqz2 = vec_madd( qy, qz2, (vec_float4)(0.0f) );
    qyqw2 = vec_madd( qw, qy2, (vec_float4)(0.0f) );
    qzqz2 = vec_madd( qz, qz2, (vec_float4)(0.0f) );
    qzqw2 = vec_madd( qw, qz2, (vec_float4)(0.0f) );
    vmathSoaV3MakeFromElems( &result->col0, vec_sub( vec_sub( (vec_float4)(1.0f), qyqy2 ), qzqz2 ), vec_add( qxqy2, qzqw2 ), vec_sub( qxqz2, qyqw2 ) );
    vmathSoaV3MakeFromElems( &result->col1, vec_sub( qxqy2, qzqw2 ), vec_sub( vec_sub( (vec_float4)(1.0f), qxqx2 ), qzqz2 ), vec_add( qyqz2, qxqw2 ) );
    vmathSoaV3MakeFromElems( &result->col2, vec_add( qxqz2, qyqw2 ), vec_sub( qyqz2, qxqw2 ), vec_sub( vec_sub( (vec_float4)(1.0f), qxqx2 ), qyqy2 ) );
}
...
static inline void vmathSoaM3Inverse( VmathSoaMatrix3 *result, const VmathSoaMatrix3 *mat )
{
    ...
    vmathSoaV3MakeFromElems( &result->col0, vec_madd( tmp0.x, detinv, (vec_float4)(0.0f) ), vec_madd( tmp1.x, detinv, (vec_float4)(0.0f) ), vec_madd( tmp2.x, detinv, (vec_float4)(0.0f) ) );
    vmathSoaV3MakeFromElems( &result->col1, vec_madd( tmp0.y, detinv, (vec_float4)(0.0f) ), vec_madd( tmp1.y, detinv, (vec_float4)(0.0f) ), vec_madd( tmp2.y, detinv, (vec_float4)(0.0f) ) );
    vmathSoaV3MakeFromElems( &result->col2, vec_madd( tmp0.z, detinv, (vec_float4)(0.0f) ), vec_madd( tmp1.z, detinv, (vec_float4)(0.0f) ), vec_madd( tmp2.z, detinv, (vec_float4)(0.0f) ) );
}
...
static inline void vmathSoaM3MulV3( VmathSoaVector3 *result, const VmathSoaMatrix3 *mat, const VmathSoaVector3 *vec )
{
    ...
    tmpX = vec_add( vec_add( vec_madd( mat->col0.x, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.x, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.x, vec->z, (vec_float4)(0.0f) ) );
    tmpY = vec_add( vec_add( vec_madd( mat->col0.y, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.y, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.y, vec->z, (vec_float4)(0.0f) ) );
    tmpZ = vec_add( vec_add( vec_madd( mat->col0.z, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.z, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.z, vec->z, (vec_float4)(0.0f) ) );
...
static inline void vmathSoaM3MakeRotationX( VmathSoaMatrix3 *result, vec_float4 radians )
{
    ...
    vmathSoaV3MakeXAxis( &result->col0 );
    vmathSoaV3MakeFromElems( &result->col1, (vec_float4)(0.0f), c, s );
    vmathSoaV3MakeFromElems( &result->col2, (vec_float4)(0.0f), negatef4( s ), c );
}
...
static inline void vmathSoaM3MakeRotationY( VmathSoaMatrix3 *result, vec_float4 radians )
{
    vec_float4 s, c;
    sincosf4( radians, &s, &c );
    vmathSoaV3MakeFromElems( &result->col0, c, (vec_float4)(0.0f), negatef4( s ) );
    vmathSoaV3MakeYAxis( &result->col1 );
    vmathSoaV3MakeFromElems( &result->col2, s, (vec_float4)(0.0f), c );
}
...
static inline void vmathSoaM3MakeRotationZ( VmathSoaMatrix3 *result, vec_float4 radians )
{
    vec_float4 s, c;
    sincosf4( radians, &s, &c );
    vmathSoaV3MakeFromElems( &result->col0, c, s, (vec_float4)(0.0f) );
    vmathSoaV3MakeFromElems( &result->col1, negatef4( s ), c, (vec_float4)(0.0f) );
    vmathSoaV3MakeZAxis( &result->col2 );
}
...
static inline void vmathSoaM3MakeRotationZYX( VmathSoaMatrix3 *result, const VmathSoaVector3 *radiansXYZ )
{
    ...
    tmp0 = vec_madd( cZ, sY, (vec_float4)(0.0f) );
    tmp1 = vec_madd( sZ, sY, (vec_float4)(0.0f) );
    vmathSoaV3MakeFromElems( &result->col0, vec_madd( cZ, cY, (vec_float4)(0.0f) ), vec_madd( sZ, cY, (vec_float4)(0.0f) ), negatef4( sY ) );
    vmathSoaV3MakeFromElems( &result->col1, vec_sub( vec_madd( tmp0, sX, (vec_float4)(0.0f) ), vec_madd( sZ, cX, (vec_float4)(0.0f) ) ), vec_add( vec_madd( tmp1, sX, (vec_float4)(0.0f) ), vec_madd( cZ, cX, (vec_float4)(0.0f) ) ), vec_madd( cY, sX, (vec_float4)(0.0f) ) );
    vmathSoaV3MakeFromElems( &result->col2, vec_add( vec_madd( tmp0, cX, (vec_float4)(0.0f) ), vec_madd( sZ, sX, (vec_float4)(0.0f) ) ), vec_sub( vec_madd( tmp1, cX, (vec_float4)(0.0f) ), vec_madd( cZ, sX, (vec_float4)(0.0f) ) ), vec_madd( cY, cX, (vec_float4)(0.0f) ) );
}
...
static inline void vmathSoaM3MakeRotationAxis( VmathSoaMatrix3 *result, vec_float4 radians, const VmathSoaVector3 *unitVec )
{
    ...
    y = unitVec->y;
    z = unitVec->z;
    xy = vec_madd( x, y, (vec_float4)(0.0f) );
    yz = vec_madd( y, z, (vec_float4)(0.0f) );
    zx = vec_madd( z, x, (vec_float4)(0.0f) );
    oneMinusC = vec_sub( (vec_float4)(1.0f), c );
    vmathSoaV3MakeFromElems( &result->col0, vec_add( vec_madd( vec_madd( x, x, (vec_float4)(0.0f) ), oneMinusC, (vec_float4)(0.0f) ), c ), vec_add( vec_madd( xy, oneMinusC, (vec_float4)(0.0f) ), vec_madd( z, s, (vec_float4)(0.0f) ) ), vec_sub( vec_madd( zx, oneMinusC, (vec_float4)(0.0f) ), vec_madd( y, s, (vec_float4)(0.0f) ) ) );
    vmathSoaV3MakeFromElems( &result->col1, vec_sub( vec_madd( xy, oneMinusC, (vec_float4)(0.0f) ), vec_madd( z, s, (vec_float4)(0.0f) ) ), vec_add( vec_madd( vec_madd( y, y, (vec_float4)(0.0f) ), oneMinusC, (vec_float4)(0.0f) ), c ), vec_add( vec_madd( yz, oneMinusC, (vec_float4)(0.0f) ), vec_madd( x, s, (vec_float4)(0.0f) ) ) );
    vmathSoaV3MakeFromElems( &result->col2, vec_add( vec_madd( zx, oneMinusC, (vec_float4)(0.0f) ), vec_madd( y, s, (vec_float4)(0.0f) ) ), vec_sub( vec_madd( yz, oneMinusC, (vec_float4)(0.0f) ), vec_madd( x, s, (vec_float4)(0.0f) ) ), vec_add( vec_madd( vec_madd( z, z, (vec_float4)(0.0f) ), oneMinusC, (vec_float4)(0.0f) ), c ) );
}
...
{
    vmathSoaV3MakeFromElems( &result->col0, scaleVec->x, (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV3MakeFromElems( &result->col1, (vec_float4)(0.0f), scaleVec->y, (vec_float4)(0.0f) );
    vmathSoaV3MakeFromElems( &result->col2, (vec_float4)(0.0f), (vec_float4)(0.0f), scaleVec->z );
}
...
{
    vmathSoaV4MakeFromV3Scalar( &result->col0, &mat->col0, (vec_float4)(0.0f) );
    vmathSoaV4MakeFromV3Scalar( &result->col1, &mat->col1, (vec_float4)(0.0f) );
    vmathSoaV4MakeFromV3Scalar( &result->col2, &mat->col2, (vec_float4)(0.0f) );
    vmathSoaV4MakeFromV3Scalar( &result->col3, &mat->col3, (vec_float4)(1.0f) );
}
...
static inline void vmathSoaM4MakeFromM3V3( VmathSoaMatrix4 *result, const VmathSoaMatrix3 *mat, const VmathSoaVector3 *translateVec )
{
    ...
    vmathSoaV4MakeFromV3Scalar( &result->col1, &mat->col1, (vec_float4)(0.0f) );
    vmathSoaV4MakeFromV3Scalar( &result->col2, &mat->col2, (vec_float4)(0.0f) );
    vmathSoaV4MakeFromV3Scalar( &result->col3, translateVec, (vec_float4)(1.0f) );
}
...
static inline void vmathSoaM4Inverse( VmathSoaMatrix4 *result, const VmathSoaMatrix4 *mat )
{
    ...
    mO = mat->col3.z;
    mP = mat->col3.w;
    tmp0 = vec_sub( vec_madd( mK, mD, (vec_float4)(0.0f) ), vec_madd( mC, mL, (vec_float4)(0.0f) ) );
    tmp1 = vec_sub( vec_madd( mO, mH, (vec_float4)(0.0f) ), vec_madd( mG, mP, (vec_float4)(0.0f) ) );
    tmp2 = vec_sub( vec_madd( mB, mK, (vec_float4)(0.0f) ), vec_madd( mJ, mC, (vec_float4)(0.0f) ) );
    tmp3 = vec_sub( vec_madd( mF, mO, (vec_float4)(0.0f) ), vec_madd( mN, mG, (vec_float4)(0.0f) ) );
    tmp4 = vec_sub( vec_madd( mJ, mD, (vec_float4)(0.0f) ), vec_madd( mB, mL, (vec_float4)(0.0f) ) );
    tmp5 = vec_sub( vec_madd( mN, mH, (vec_float4)(0.0f) ), vec_madd( mF, mP, (vec_float4)(0.0f) ) );
    vmathSoaV4SetX( &res0, vec_sub( vec_sub( vec_madd( mJ, tmp1, (vec_float4)(0.0f) ), vec_madd( mL, tmp3, (vec_float4)(0.0f) ) ), vec_madd( mK, tmp5, (vec_float4)(0.0f) ) ) );
    vmathSoaV4SetY( &res0, vec_sub( vec_sub( vec_madd( mN, tmp0, (vec_float4)(0.0f) ), vec_madd( mP, tmp2, (vec_float4)(0.0f) ) ), vec_madd( mO, tmp4, (vec_float4)(0.0f) ) ) );
    vmathSoaV4SetZ( &res0, vec_sub( vec_add( vec_madd( mD, tmp3, (vec_float4)(0.0f) ), vec_madd( mC, tmp5, (vec_float4)(0.0f) ) ), vec_madd( mB, tmp1, (vec_float4)(0.0f) ) ) );
    vmathSoaV4SetW( &res0, vec_sub( vec_add( vec_madd( mH, tmp2, (vec_float4)(0.0f) ), vec_madd( mG, tmp4, (vec_float4)(0.0f) ) ), vec_madd( mF, tmp0, (vec_float4)(0.0f) ) ) );
    detInv = recipf4( vec_add( vec_add( vec_add( vec_madd( mA, res0.x, (vec_float4)(0.0f) ), vec_madd( mE, res0.y, (vec_float4)(0.0f) ) ), vec_madd( mI, res0.z, (vec_float4)(0.0f) ) ), vec_madd( mM, res0.w, (vec_float4)(0.0f) ) ) );
    vmathSoaV4SetX( &res1, vec_madd( mI, tmp1, (vec_float4)(0.0f) ) );
    vmathSoaV4SetY( &res1, vec_madd( mM, tmp0, (vec_float4)(0.0f) ) );
    vmathSoaV4SetZ( &res1, vec_madd( mA, tmp1, (vec_float4)(0.0f) ) );
    vmathSoaV4SetW( &res1, vec_madd( mE, tmp0, (vec_float4)(0.0f) ) );
    vmathSoaV4SetX( &res3, vec_madd( mI, tmp3, (vec_float4)(0.0f) ) );
    vmathSoaV4SetY( &res3, vec_madd( mM, tmp2, (vec_float4)(0.0f) ) );
    vmathSoaV4SetZ( &res3, vec_madd( mA, tmp3, (vec_float4)(0.0f) ) );
    vmathSoaV4SetW( &res3, vec_madd( mE, tmp2, (vec_float4)(0.0f) ) );
    vmathSoaV4SetX( &res2, vec_madd( mI, tmp5, (vec_float4)(0.0f) ) );
    vmathSoaV4SetY( &res2, vec_madd( mM, tmp4, (vec_float4)(0.0f) ) );
    vmathSoaV4SetZ( &res2, vec_madd( mA, tmp5, (vec_float4)(0.0f) ) );
    vmathSoaV4SetW( &res2, vec_madd( mE, tmp4, (vec_float4)(0.0f) ) );
    tmp0 = vec_sub( vec_madd( mI, mB, (vec_float4)(0.0f) ), vec_madd( mA, mJ, (vec_float4)(0.0f) ) );
    tmp1 = vec_sub( vec_madd( mM, mF, (vec_float4)(0.0f) ), vec_madd( mE, mN, (vec_float4)(0.0f) ) );
    tmp2 = vec_sub( vec_madd( mI, mD, (vec_float4)(0.0f) ), vec_madd( mA, mL, (vec_float4)(0.0f) ) );
    tmp3 = vec_sub( vec_madd( mM, mH, (vec_float4)(0.0f) ), vec_madd( mE, mP, (vec_float4)(0.0f) ) );
    tmp4 = vec_sub( vec_madd( mI, mC, (vec_float4)(0.0f) ), vec_madd( mA, mK, (vec_float4)(0.0f) ) );
    tmp5 = vec_sub( vec_madd( mM, mG, (vec_float4)(0.0f) ), vec_madd( mE, mO, (vec_float4)(0.0f) ) );
    vmathSoaV4SetX( &res2, vec_add( vec_sub( vec_madd( mL, tmp1, (vec_float4)(0.0f) ), vec_madd( mJ, tmp3, (vec_float4)(0.0f) ) ), res2.x ) );
    vmathSoaV4SetY( &res2, vec_add( vec_sub( vec_madd( mP, tmp0, (vec_float4)(0.0f) ), vec_madd( mN, tmp2, (vec_float4)(0.0f) ) ), res2.y ) );
    vmathSoaV4SetZ( &res2, vec_sub( vec_sub( vec_madd( mB, tmp3, (vec_float4)(0.0f) ), vec_madd( mD, tmp1, (vec_float4)(0.0f) ) ), res2.z ) );
    vmathSoaV4SetW( &res2, vec_sub( vec_sub( vec_madd( mF, tmp2, (vec_float4)(0.0f) ), vec_madd( mH, tmp0, (vec_float4)(0.0f) ) ), res2.w ) );
    vmathSoaV4SetX( &res3, vec_add( vec_sub( vec_madd( mJ, tmp5, (vec_float4)(0.0f) ), vec_madd( mK, tmp1, (vec_float4)(0.0f) ) ), res3.x ) );
    vmathSoaV4SetY( &res3, vec_add( vec_sub( vec_madd( mN, tmp4, (vec_float4)(0.0f) ), vec_madd( mO, tmp0, (vec_float4)(0.0f) ) ), res3.y ) );
    vmathSoaV4SetZ( &res3, vec_sub( vec_sub( vec_madd( mC, tmp1, (vec_float4)(0.0f) ), vec_madd( mB, tmp5, (vec_float4)(0.0f) ) ), res3.z ) );
    vmathSoaV4SetW( &res3, vec_sub( vec_sub( vec_madd( mG, tmp0, (vec_float4)(0.0f) ), vec_madd( mF, tmp4, (vec_float4)(0.0f) ) ), res3.w ) );
    vmathSoaV4SetX( &res1, vec_sub( vec_sub( vec_madd( mK, tmp3, (vec_float4)(0.0f) ), vec_madd( mL, tmp5, (vec_float4)(0.0f) ) ), res1.x ) );
    vmathSoaV4SetY( &res1, vec_sub( vec_sub( vec_madd( mO, tmp2, (vec_float4)(0.0f) ), vec_madd( mP, tmp4, (vec_float4)(0.0f) ) ), res1.y ) );
    vmathSoaV4SetZ( &res1, vec_add( vec_sub( vec_madd( mD, tmp5, (vec_float4)(0.0f) ), vec_madd( mC, tmp3, (vec_float4)(0.0f) ) ), res1.z ) );
    vmathSoaV4SetW( &res1, vec_add( vec_sub( vec_madd( mH, tmp4, (vec_float4)(0.0f) ), vec_madd( mG, tmp2, (vec_float4)(0.0f) ) ), res1.w ) );
...
static inline vec_float4 vmathSoaM4Determinant( const VmathSoaMatrix4 *mat )
{
    ...
    tmp4 = vec_sub( vec_madd( mJ, mD, (vec_float4)(0.0f) ), vec_madd( mB, mL, (vec_float4)(0.0f) ) );
    tmp5 = vec_sub( vec_madd( mN, mH, (vec_float4)(0.0f) ), vec_madd( mF, mP, (vec_float4)(0.0f) ) );
    dx = vec_sub( vec_sub( vec_madd( mJ, tmp1, (vec_float4)(0.0f) ), vec_madd( mL, tmp3, (vec_float4)(0.0f) ) ), vec_madd( mK, tmp5, (vec_float4)(0.0f) ) );
    dy = vec_sub( vec_sub( vec_madd( mN, tmp0, (vec_float4)(0.0f) ), vec_madd( mP, tmp2, (vec_float4)(0.0f) ) ), vec_madd( mO, tmp4, (vec_float4)(0.0f) ) );
    dz = vec_sub( vec_add( vec_madd( mD, tmp3, (vec_float4)(0.0f) ), vec_madd( mC, tmp5, (vec_float4)(0.0f) ) ), vec_madd( mB, tmp1, (vec_float4)(0.0f) ) );
    dw = vec_sub( vec_add( vec_madd( mH, tmp2, (vec_float4)(0.0f) ), vec_madd( mG, tmp4, (vec_float4)(0.0f) ) ), vec_madd( mF, tmp0, (vec_float4)(0.0f) ) );
    return vec_add( vec_add( vec_add( vec_madd( mA, dx, (vec_float4)(0.0f) ), vec_madd( mE, dy, (vec_float4)(0.0f) ) ), vec_madd( mI, dz, (vec_float4)(0.0f) ) ), vec_madd( mM, dw, (vec_float4)(0.0f) ) );
}
...
static inline void vmathSoaM4MulV4( VmathSoaVector4 *result, const VmathSoaMatrix4 *mat, const VmathSoaVector4 *vec )
{
    ...
    tmpX = vec_add( vec_add( vec_add( vec_madd( mat->col0.x, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.x, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.x, vec->z, (vec_float4)(0.0f) ) ), vec_madd( mat->col3.x, vec->w, (vec_float4)(0.0f) ) );
    tmpY = vec_add( vec_add( vec_add( vec_madd( mat->col0.y, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.y, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.y, vec->z, (vec_float4)(0.0f) ) ), vec_madd( mat->col3.y, vec->w, (vec_float4)(0.0f) ) );
    tmpZ = vec_add( vec_add( vec_add( vec_madd( mat->col0.z, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.z, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.z, vec->z, (vec_float4)(0.0f) ) ), vec_madd( mat->col3.z, vec->w, (vec_float4)(0.0f) ) );
    tmpW = vec_add( vec_add( vec_add( vec_madd( mat->col0.w, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.w, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.w, vec->z, (vec_float4)(0.0f) ) ), vec_madd( mat->col3.w, vec->w, (vec_float4)(0.0f) ) );
...
{
    result->x = vec_add( vec_add( vec_madd( mat->col0.x, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.x, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.x, vec->z, (vec_float4)(0.0f) ) );
    result->y = vec_add( vec_add( vec_madd( mat->col0.y, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.y, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.y, vec->z, (vec_float4)(0.0f) ) );
    result->z = vec_add( vec_add( vec_madd( mat->col0.z, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.z, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.z, vec->z, (vec_float4)(0.0f) ) );
    result->w = vec_add( vec_add( vec_madd( mat->col0.w, vec->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.w, vec->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.w, vec->z, (vec_float4)(0.0f) ) );
}

static inline void vmathSoaM4MulP3( VmathSoaVector4 *result, const VmathSoaMatrix4 *mat, const VmathSoaPoint3 *pnt )
{
    result->x = vec_add( vec_add( vec_add( vec_madd( mat->col0.x, pnt->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.x, pnt->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.x, pnt->z, (vec_float4)(0.0f) ) ), mat->col3.x );
    result->y = vec_add( vec_add( vec_add( vec_madd( mat->col0.y, pnt->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.y, pnt->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.y, pnt->z, (vec_float4)(0.0f) ) ), mat->col3.y );
    result->z = vec_add( vec_add( vec_add( vec_madd( mat->col0.z, pnt->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.z, pnt->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.z, pnt->z, (vec_float4)(0.0f) ) ), mat->col3.z );
    result->w = vec_add( vec_add( vec_add( vec_madd( mat->col0.w, pnt->x, (vec_float4)(0.0f) ), vec_madd( mat->col1.w, pnt->y, (vec_float4)(0.0f) ) ), vec_madd( mat->col2.w, pnt->z, (vec_float4)(0.0f) ) ), mat->col3.w );
}
...
static inline void vmathSoaM4MakeRotationX( VmathSoaMatrix4 *result, vec_float4 radians )
{
    ...
    sincosf4( radians, &s, &c );
    vmathSoaV4MakeXAxis( &result->col0 );
    vmathSoaV4MakeFromElems( &result->col1, (vec_float4)(0.0f), c, s, (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col2, (vec_float4)(0.0f), negatef4( s ), c, (vec_float4)(0.0f) );
    vmathSoaV4MakeWAxis( &result->col3 );
}
...
static inline void vmathSoaM4MakeRotationY( VmathSoaMatrix4 *result, vec_float4 radians )
{
    vec_float4 s, c;
    sincosf4( radians, &s, &c );
    vmathSoaV4MakeFromElems( &result->col0, c, (vec_float4)(0.0f), negatef4( s ), (vec_float4)(0.0f) );
    vmathSoaV4MakeYAxis( &result->col1 );
    vmathSoaV4MakeFromElems( &result->col2, s, (vec_float4)(0.0f), c, (vec_float4)(0.0f) );
    vmathSoaV4MakeWAxis( &result->col3 );
}
...
static inline void vmathSoaM4MakeRotationZ( VmathSoaMatrix4 *result, vec_float4 radians )
{
    vec_float4 s, c;
    sincosf4( radians, &s, &c );
    vmathSoaV4MakeFromElems( &result->col0, c, s, (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col1, negatef4( s ), c, (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeZAxis( &result->col2 );
    vmathSoaV4MakeWAxis( &result->col3 );
}
...
static inline void vmathSoaM4MakeRotationZYX( VmathSoaMatrix4 *result, const VmathSoaVector3 *radiansXYZ )
{
    ...
    tmp0 = vec_madd( cZ, sY, (vec_float4)(0.0f) );
    tmp1 = vec_madd( sZ, sY, (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col0, vec_madd( cZ, cY, (vec_float4)(0.0f) ), vec_madd( sZ, cY, (vec_float4)(0.0f) ), negatef4( sY ), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col1, vec_sub( vec_madd( tmp0, sX, (vec_float4)(0.0f) ), vec_madd( sZ, cX, (vec_float4)(0.0f) ) ), vec_add( vec_madd( tmp1, sX, (vec_float4)(0.0f) ), vec_madd( cZ, cX, (vec_float4)(0.0f) ) ), vec_madd( cY, sX, (vec_float4)(0.0f) ), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col2, vec_add( vec_madd( tmp0, cX, (vec_float4)(0.0f) ), vec_madd( sZ, sX, (vec_float4)(0.0f) ) ), vec_sub( vec_madd( tmp1, cX, (vec_float4)(0.0f) ), vec_madd( cZ, sX, (vec_float4)(0.0f) ) ), vec_madd( cY, cX, (vec_float4)(0.0f) ), (vec_float4)(0.0f) );
    vmathSoaV4MakeWAxis( &result->col3 );
}
...
static inline void vmathSoaM4MakeRotationAxis( VmathSoaMatrix4 *result, vec_float4 radians, const VmathSoaVector3 *unitVec )
{
    ...
    zx = vec_madd( z, x, (vec_float4)(0.0f) );
    oneMinusC = vec_sub( (vec_float4)(1.0f), c );
    vmathSoaV4MakeFromElems( &result->col0, vec_add( vec_madd( vec_madd( x, x, (vec_float4)(0.0f) ), oneMinusC, (vec_float4)(0.0f) ), c ), vec_add( vec_madd( xy, oneMinusC, (vec_float4)(0.0f) ), vec_madd( z, s, (vec_float4)(0.0f) ) ), vec_sub( vec_madd( zx, oneMinusC, (vec_float4)(0.0f) ), vec_madd( y, s, (vec_float4)(0.0f) ) ), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col1, vec_sub( vec_madd( xy, oneMinusC, (vec_float4)(0.0f) ), vec_madd( z, s, (vec_float4)(0.0f) ) ), vec_add( vec_madd( vec_madd( y, y, (vec_float4)(0.0f) ), oneMinusC, (vec_float4)(0.0f) ), c ), vec_add( vec_madd( yz, oneMinusC, (vec_float4)(0.0f) ), vec_madd( x, s, (vec_float4)(0.0f) ) ), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col2, vec_add( vec_madd( zx, oneMinusC, (vec_float4)(0.0f) ), vec_madd( y, s, (vec_float4)(0.0f) ) ), vec_sub( vec_madd( yz, oneMinusC, (vec_float4)(0.0f) ), vec_madd( x, s, (vec_float4)(0.0f) ) ), vec_add( vec_madd( vec_madd( z, z, (vec_float4)(0.0f) ), oneMinusC, (vec_float4)(0.0f) ), c ), (vec_float4)(0.0f) );
    vmathSoaV4MakeWAxis( &result->col3 );
}
...
{
    vmathSoaV4MakeFromElems( &result->col0, scaleVec->x, (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col1, (vec_float4)(0.0f), scaleVec->y, (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col2, (vec_float4)(0.0f), (vec_float4)(0.0f), scaleVec->z, (vec_float4)(0.0f) );
    vmathSoaV4MakeWAxis( &result->col3 );
}
...
static inline void vmathSoaM4PrependScale( VmathSoaMatrix4 *result, const VmathSoaVector3 *scaleVec, const VmathSoaMatrix4 *mat )
{
    ...
    vmathSoaV4MakeFromV3Scalar( &scale4, scaleVec, (vec_float4)(1.0f) );
...
static inline void vmathSoaM4MakePerspective( VmathSoaMatrix4 *result, vec_float4 fovyRadians, vec_float4 aspect, vec_float4 zNear, vec_float4 zFar )
{
    ...
    f = tanf4( vec_sub( (vec_float4)(_VECTORMATH_PI_OVER_2), vec_madd( (vec_float4)(0.5f), fovyRadians, (vec_float4)(0.0f) ) ) );
    rangeInv = recipf4( vec_sub( zNear, zFar ) );
    vmathSoaV4MakeFromElems( &result->col0, divf4( f, aspect ), (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col1, (vec_float4)(0.0f), f, (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col2, (vec_float4)(0.0f), (vec_float4)(0.0f), vec_madd( vec_add( zNear, zFar ), rangeInv, (vec_float4)(0.0f) ), (vec_float4)(-1.0f) );
    vmathSoaV4MakeFromElems( &result->col3, (vec_float4)(0.0f), (vec_float4)(0.0f), vec_madd( vec_madd( vec_madd( zNear, zFar, (vec_float4)(0.0f) ), rangeInv, (vec_float4)(0.0f) ), (vec_float4)(2.0f), (vec_float4)(0.0f) ), (vec_float4)(0.0f) );
}
...
static inline void vmathSoaM4MakeFrustum( VmathSoaMatrix4 *result, vec_float4 left, vec_float4 right, vec_float4 bottom, vec_float4 top, vec_float4 zNear, vec_float4 zFar )
{
    ...
    inv_rl = recipf4( vec_sub( right, left ) );
    inv_tb = recipf4( vec_sub( top, bottom ) );
    inv_nf = recipf4( vec_sub( zNear, zFar ) );
    n2 = vec_add( zNear, zNear );
    vmathSoaV4MakeFromElems( &result->col0, vec_madd( n2, inv_rl, (vec_float4)(0.0f) ), (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col1, (vec_float4)(0.0f), vec_madd( n2, inv_tb, (vec_float4)(0.0f) ), (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col2, vec_madd( sum_rl, inv_rl, (vec_float4)(0.0f) ), vec_madd( sum_tb, inv_tb, (vec_float4)(0.0f) ), vec_madd( sum_nf, inv_nf, (vec_float4)(0.0f) ), (vec_float4)(-1.0f) );
    vmathSoaV4MakeFromElems( &result->col3, (vec_float4)(0.0f), (vec_float4)(0.0f), vec_madd( vec_madd( n2, inv_nf, (vec_float4)(0.0f) ), zFar, (vec_float4)(0.0f) ), (vec_float4)(0.0f) );
}
...
static inline void vmathSoaM4MakeOrthographic( VmathSoaMatrix4 *result, vec_float4 left, vec_float4 right, vec_float4 bottom, vec_float4 top, vec_float4 zNear, vec_float4 zFar )
{
    ...
    inv_tb = recipf4( vec_sub( top, bottom ) );
    inv_nf = recipf4( vec_sub( zNear, zFar ) );
    vmathSoaV4MakeFromElems( &result->col0, vec_add( inv_rl, inv_rl ), (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col1, (vec_float4)(0.0f), vec_add( inv_tb, inv_tb ), (vec_float4)(0.0f), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col2, (vec_float4)(0.0f), (vec_float4)(0.0f), vec_add( inv_nf, inv_nf ), (vec_float4)(0.0f) );
    vmathSoaV4MakeFromElems( &result->col3, vec_madd( negatef4( sum_rl ), inv_rl, (vec_float4)(0.0f) ), vec_madd( negatef4( sum_tb ), inv_tb, (vec_float4)(0.0f) ), vec_madd( sum_nf, inv_nf, (vec_float4)(0.0f) ), (vec_float4)(1.0f) );
}
...
static inline void vmathSoaT3Inverse( VmathSoaTransform3 *result, const VmathSoaTransform3 *tfrm )
{
    ...
    vmathSoaV3MakeFromElems( &inv0, vec_madd( tmp0.x, detinv, (vec_float4)(0.0f) ), vec_madd( tmp1.x, detinv, (vec_float4)(0.0f) ), vec_madd( tmp2.x, detinv, (vec_float4)(0.0f) ) );
    vmathSoaV3MakeFromElems( &inv1, vec_madd( tmp0.y, detinv, (vec_float4)(0.0f) ), vec_madd( tmp1.y, detinv, (vec_float4)(0.0f) ), vec_madd( tmp2.y, detinv, (vec_float4)(0.0f) ) );
    vmathSoaV3MakeFromElems( &inv2, vec_madd( tmp0.z, detinv, (vec_float4)(0.0f) ), vec_madd( tmp1.z, detinv, (vec_float4)(0.0f) ), vec_madd( tmp2.z, detinv, (vec_float4)(0.0f) ) );
...
{
    vec_float4 tmpX, tmpY, tmpZ;
    tmpX = vec_add( vec_add( vec_madd( tfrm->col0.x, vec->x, (vec_float4)(0.0f) ), vec_madd( tfrm->col1.x, vec->y, (vec_float4)(0.0f) ) ), vec_madd( tfrm->col2.x, vec->z, (vec_float4)(0.0f) ) );
    tmpY = vec_add( vec_add( vec_madd( tfrm->col0.y, vec->x, (vec_float4)(0.0f) ), vec_madd( tfrm->col1.y, vec->y, (vec_float4)(0.0f) ) ), vec_madd( tfrm->col2.y, vec->z, (vec_float4)(0.0f) ) );
    tmpZ = vec_add( vec_add( vec_madd( tfrm->col0.z, vec->x, (vec_float4)(0.0f) ), vec_madd( tfrm->col1.z, vec->y, (vec_float4)(0.0f) ) ), vec_madd( tfrm->col2.z, vec->z, (vec_float4)(0.0f) ) );
    vmathSoaV3MakeFromElems( result, tmpX, tmpY, tmpZ );
}
...
{
    vec_float4 tmpX, tmpY, tmpZ;
    tmpX = vec_add( vec_add( vec_add( vec_madd( tfrm->col0.x, pnt->x, (vec_float4)(0.0f) ), vec_madd( tfrm->col1.x, pnt->y, (vec_float4)(0.0f) ) ), vec_madd( tfrm->col2.x, pnt->z, (vec_float4)(0.0f) ) ), tfrm->col3.x );
    tmpY = vec_add( vec_add( vec_add( vec_madd( tfrm->col0.y, pnt->x, (vec_float4)(0.0f) ), vec_madd( tfrm->col1.y, pnt->y, (vec_float4)(0.0f) ) ), vec_madd( tfrm->col2.y, pnt->z, (vec_float4)(0.0f) ) ), tfrm->col3.y );
    tmpZ = vec_add( vec_add( vec_add( vec_madd( tfrm->col0.z, pnt->x, (vec_float4)(0.0f) ), vec_madd( tfrm->col1.z, pnt->y, (vec_float4)(0.0f) ) ), vec_madd( tfrm->col2.z, pnt->z, (vec_float4)(0.0f) ) ), tfrm->col3.z );
...
static inline void vmathSoaT3MakeIdentity( VmathSoaTransform3 *result )
{
    ...
    vmathSoaV3MakeYAxis( &result->col1 );
    vmathSoaV3MakeZAxis( &result->col2 );
    vmathSoaV3MakeFromScalar( &result->col3, (vec_float4)(0.0f) );
}
...
static inline void vmathSoaT3MakeRotationAxis( VmathSoaTransform3 *result, vec_float4 radians, const VmathSoaVector3 *unitVec )
{
    ...
    vmathSoaV3MakeFromScalar( &tmpV3_0, (vec_float4)(0.0f) );
...
static inline void vmathSoaQMakeFromM3( VmathSoaQuat *result, const VmathSoaMatrix3 *tfrm )
{
    ...
    negTrace = (vec_uint4)vec_cmpgt( (vec_float4)(0.0f), trace );
    ...
    radicand = vec_add( vec_add( vec_add( xx, yy ), zz ), (vec_float4)(1.0f) );
    scale = vec_madd( (vec_float4)(0.5f), rsqrtf4( radicand ), (vec_float4)(0.0f) );

    tmpx = vec_madd( vec_sub( zy, yz ), scale, (vec_float4)(0.0f) );
    tmpy = vec_madd( vec_sub( xz, zx ), scale, (vec_float4)(0.0f) );
    tmpz = vec_madd( vec_sub( yx, xy ), scale, (vec_float4)(0.0f) );
    tmpw = vec_madd( radicand, scale, (vec_float4)(0.0f) );
    qx = tmpx;
    qy = tmpy;
    qz = tmpz;
    qw = tmpw;
...
{
    vec_float4 tmpX, tmpY, tmpZ;
    tmpX = vec_add( vec_add( vec_madd( vec->x, mat->col0.x, (vec_float4)(0.0f) ), vec_madd( vec->y, mat->col0.y, (vec_float4)(0.0f) ) ), vec_madd( vec->z, mat->col0.z, (vec_float4)(0.0f) ) );
    tmpY = vec_add( vec_add( vec_madd( vec->x, mat->col1.x, (vec_float4)(0.0f) ), vec_madd( vec->y, mat->col1.y, (vec_float4)(0.0f) ) ), vec_madd( vec->z, mat->col1.z, (vec_float4)(0.0f) ) );
    tmpZ = vec_add( vec_add( vec_madd( vec->x, mat->col2.x, (vec_float4)(0.0f) ), vec_madd( vec->y, mat->col2.y, (vec_float4)(0.0f) ) ), vec_madd( vec->z, mat->col2.z, (vec_float4)(0.0f) ) );
    vmathSoaV3MakeFromElems( result, tmpX, tmpY, tmpZ );
}

static inline void vmathSoaV3CrossMatrix( VmathSoaMatrix3 *result, const VmathSoaVector3 *vec )
{
    vmathSoaV3MakeFromElems( &result->col0, (vec_float4)(0.0f), vec->z, negatef4( vec->y ) );
    vmathSoaV3MakeFromElems( &result->col1, negatef4( vec->z ), (vec_float4)(0.0f), vec->x );
    vmathSoaV3MakeFromElems( &result->col2, vec->y, negatef4( vec->x ), (vec_float4)(0.0f) );
}
