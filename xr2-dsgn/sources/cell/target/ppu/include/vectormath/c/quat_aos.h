...
static inline void vmathQSlerp( VmathQuat *result, float t, const VmathQuat *unitQuat0, const VmathQuat *unitQuat1 )
{
    ...
    result->vec128 = vec_madd( start.vec128, scale0, vec_madd( unitQuat1->vec128, scale1, (vec_float4)(0.0f) ) );
}
...
{
    result->vec128 = vec_madd( quat->vec128, _vmathVfSplatScalar(scalar), (vec_float4)(0.0f) );
}
...
static inline void vmathQNormalize( VmathQuat *result, const VmathQuat *quat )
{
    ...
    result->vec128 = vec_madd( quat->vec128, rsqrtf4( dot ), (vec_float4)(0.0f) );
}
...
static inline void vmathQMakeRotationArc( VmathQuat *result, const VmathVector3 *unitVec0, const VmathVector3 *unitVec1 )
{
    ...
    cosAngle = vec_splat( cosAngle, 0 );
    cosAngleX2Plus2 = vec_madd( cosAngle, (vec_float4)(2.0f), (vec_float4)(2.0f) );
    recipCosHalfAngleX2 = rsqrtf4( cosAngleX2Plus2 );
    cosHalfAngleX2 = vec_madd( recipCosHalfAngleX2, cosAngleX2Plus2, (vec_float4)(0.0f) );
    vmathV3Cross( &tmpV3_0, unitVec0, unitVec1 );
    crossVec = tmpV3_0;
    res = vec_madd( crossVec.vec128, recipCosHalfAngleX2, (vec_float4)(0.0f) );
    res = vec_sel( res, vec_madd( cosHalfAngleX2, (vec_float4)(0.5f), (vec_float4)(0.0f) ), _VECTORMATH_MASK_0x000F );
    result->vec128 = res;
}
...
static inline void vmathQMakeRotationAxis( VmathQuat *result, float radians, const VmathVector3 *unitVec )
{
    ...
    angle = vec_madd( _vmathVfSplatScalar(radians), (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    res = vec_sel( vec_madd( unitVec->vec128, s, (vec_float4)(0.0f) ), c, _VECTORMATH_MASK_0x000F );
    result->vec128 = res;
}
...
static inline void vmathQMakeRotationX( VmathQuat *result, float radians )
{
    ...
    angle = vec_madd( _vmathVfSplatScalar(radians), (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    res = vec_sel( (vec_float4)(0.0f), s, _VECTORMATH_MASK_0xF000 );
...
static inline void vmathQMakeRotationY( VmathQuat *result, float radians )
{
    ...
    angle = vec_madd( _vmathVfSplatScalar(radians), (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    res = vec_sel( (vec_float4)(0.0f), s, _VECTORMATH_MASK_0x0F00 );
    res = vec_sel( res, c, _VECTORMATH_MASK_0x000F );
    result->vec128 = res;
}
...
static inline void vmathQMakeRotationZ( VmathQuat *result, float radians )
{
    ...
    angle = vec_madd( _vmathVfSplatScalar(radians), (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    res = vec_sel( (vec_float4)(0.0f), s, _VECTORMATH_MASK_0x00F0 );
    res = vec_sel( res, c, _VECTORMATH_MASK_0x000F );
    result->vec128 = res;
}
...
static inline void vmathQMul( VmathQuat *result, const VmathQuat *quat0, const VmathQuat *quat1 )
{
    ...
    qv = vec_madd( vec_splat( ldata, 3 ), rdata, (vec_float4)(0.0f) );
    qv = vec_madd( vec_splat( rdata, 3 ), ldata, qv );
    qv = vec_madd( tmp0, tmp1, qv );
    qv = vec_nmsub( tmp2, tmp3, qv );
    product = vec_madd( ldata, rdata, (vec_float4)(0.0f) );
...
static inline void vmathQRotate( VmathVector3 *result, const VmathQuat *quat, const VmathVector3 *vec )
{
    ...
    qv = vec_madd( wwww, vdata, (vec_float4)(0.0f) );
    qv = vec_madd( tmp0, tmp1, qv );
    qv = vec_nmsub( tmp2, tmp3, qv );
    product = vec_madd( qdata, vdata, (vec_float4)(0.0f) );
    ...
    res = vec_madd( vec_splat( qw, 0 ), qdata, (vec_float4)(0.0f) );
