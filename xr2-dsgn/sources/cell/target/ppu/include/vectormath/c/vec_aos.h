...
static inline void vmathV3Slerp( VmathVector3 *result, float t, const VmathVector3 *unitVec0, const VmathVector3 *unitVec1 )
{
    ...
    result->vec128 = vec_madd( unitVec0->vec128, scale0, vec_madd( unitVec1->vec128, scale1, (vec_float4)(0.0f) ) );
}
...
{
    result->vec128 = vec_madd( vec->vec128, _vmathVfSplatScalar(scalar), (vec_float4)(0.0f) );
}
...
{
    result->vec128 = vec_madd( vec0->vec128, vec1->vec128, (vec_float4)(0.0f) );
}
...
static inline void vmathV3Normalize( VmathVector3 *result, const VmathVector3 *vec )
{
    ...
    dot = vec_splat( dot, 0 );
    result->vec128 = vec_madd( vec->vec128, rsqrtf4( dot ), (vec_float4)(0.0f) );
}
...
{
    result->vec128 = vec->vec128;
    result->vec128 = _vmathVfInsert(result->vec128, (vec_float4)(0.0f), 3);
}

static inline void vmathV4MakeFromP3( VmathVector4 *result, const VmathPoint3 *pnt )
{
    result->vec128 = pnt->vec128;
    result->vec128 = _vmathVfInsert(result->vec128, (vec_float4)(1.0f), 3);
}
...
{
    result->vec128 = vec_madd( pnt0->vec128, pnt1->vec128, (vec_float4)(0.0f) );
}
