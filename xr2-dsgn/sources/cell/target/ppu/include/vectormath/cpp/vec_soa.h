...
{
    return Vector3( (vec_float4)(1.0f), (vec_float4)(0.0f), (vec_float4)(0.0f) );
}

inline const Vector3 Vector3::yAxis( )
{
    return Vector3( (vec_float4)(0.0f), (vec_float4)(1.0f), (vec_float4)(0.0f) );
}

inline const Vector3 Vector3::zAxis( )
{
    return Vector3( (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(1.0f) );
}
...
inline vec_float4 & Vector3::operator []( int idx )
{
    return *(&mX + idx);
}
...
{
    return Vector3(
        vec_madd( vec0.getX(), vec1.getX(), (vec_float4)(0.0f) ),
        vec_madd( vec0.getY(), vec1.getY(), (vec_float4)(0.0f) ),
        vec_madd( vec0.getZ(), vec1.getZ(), (vec_float4)(0.0f) )
    );
}
...
{
    vec_float4 result;
    result = vec_madd( vec0.getX(), vec1.getX(), (vec_float4)(0.0f) );
    result = vec_add( result, vec_madd( vec0.getY(), vec1.getY(), (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( vec0.getZ(), vec1.getZ(), (vec_float4)(0.0f) ) );
    return result;
}
...
{
    vec_float4 result;
    result = vec_madd( vec.getX(), vec.getX(), (vec_float4)(0.0f) );
    result = vec_add( result, vec_madd( vec.getY(), vec.getY(), (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( vec.getZ(), vec.getZ(), (vec_float4)(0.0f) ) );
    return result;
}
...
inline const Vector3 normalize( const Vector3 & vec )
{
    ...
    return Vector3(
        vec_madd( vec.getX(), lenInv, (vec_float4)(0.0f) ),
        vec_madd( vec.getY(), lenInv, (vec_float4)(0.0f) ),
        vec_madd( vec.getZ(), lenInv, (vec_float4)(0.0f) )
    );
}
...
{
    return Vector3(
        vec_sub( vec_madd( vec0.getY(), vec1.getZ(), (vec_float4)(0.0f) ), vec_madd( vec0.getZ(), vec1.getY(), (vec_float4)(0.0f) ) ),
        vec_sub( vec_madd( vec0.getZ(), vec1.getX(), (vec_float4)(0.0f) ), vec_madd( vec0.getX(), vec1.getZ(), (vec_float4)(0.0f) ) ),
        vec_sub( vec_madd( vec0.getX(), vec1.getY(), (vec_float4)(0.0f) ), vec_madd( vec0.getY(), vec1.getX(), (vec_float4)(0.0f) ) )
    );
}
...
{
    return Vector4( (vec_float4)(1.0f), (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(0.0f) );
}

inline const Vector4 Vector4::yAxis( )
{
    return Vector4( (vec_float4)(0.0f), (vec_float4)(1.0f), (vec_float4)(0.0f), (vec_float4)(0.0f) );
}

inline const Vector4 Vector4::zAxis( )
{
    return Vector4( (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(1.0f), (vec_float4)(0.0f) );
}

inline const Vector4 Vector4::wAxis( )
{
    return Vector4( (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(0.0f), (vec_float4)(1.0f) );
}
...
inline vec_float4 & Vector4::operator []( int idx )
{
    return *(&mX + idx);
}
...
inline const Vector4 mulPerElem( const Vector4 & vec0, const Vector4 & vec1 )
{
    return Vector4(
        ...
        vec_madd( vec0.getY(), vec1.getY(), (vec_float4)(0.0f) ),
        vec_madd( vec0.getZ(), vec1.getZ(), (vec_float4)(0.0f) ),
        vec_madd( vec0.getW(), vec1.getW(), (vec_float4)(0.0f) )
    );
}
...
inline vec_float4 dot( const Vector4 & vec0, const Vector4 & vec1 )
{
    ...
    result = vec_add( result, vec_madd( vec0.getY(), vec1.getY(), (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( vec0.getZ(), vec1.getZ(), (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( vec0.getW(), vec1.getW(), (vec_float4)(0.0f) ) );
    return result;
}
...
inline vec_float4 lengthSqr( const Vector4 & vec )
{
    ...
    result = vec_add( result, vec_madd( vec.getY(), vec.getY(), (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( vec.getZ(), vec.getZ(), (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( vec.getW(), vec.getW(), (vec_float4)(0.0f) ) );
    return result;
}
...
inline const Vector4 normalize( const Vector4 & vec )
{
    ...
    return Vector4(
        ...
        vec_madd( vec.getY(), lenInv, (vec_float4)(0.0f) ),
        vec_madd( vec.getZ(), lenInv, (vec_float4)(0.0f) ),
        vec_madd( vec.getW(), lenInv, (vec_float4)(0.0f) )
    );
}
...
inline vec_float4 & Point3::operator []( int idx )
{
    return *(&mX + idx);
}
...
{
    return Point3(
        vec_madd( pnt0.getX(), pnt1.getX(), (vec_float4)(0.0f) ),
        vec_madd( pnt0.getY(), pnt1.getY(), (vec_float4)(0.0f) ),
        vec_madd( pnt0.getZ(), pnt1.getZ(), (vec_float4)(0.0f) )
    );
}
...
{
    vec_float4 result;
    result = vec_madd( pnt.getX(), unitVec.getX(), (vec_float4)(0.0f) );
    result = vec_add( result, vec_madd( pnt.getY(), unitVec.getY(), (vec_float4)(0.0f) ) );
    result = vec_add( result, vec_madd( pnt.getZ(), unitVec.getZ(), (vec_float4)(0.0f) ) );
    return result;
}
