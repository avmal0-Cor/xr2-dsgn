...
inline const Quat slerp( floatInVec t, Quat unitQuat0, Quat unitQuat1 )
{
    ...
    return Quat( vec_madd( start.get128(), scale0, vec_madd( unitQuat1.get128(), scale1, (vec_float4)(0.0f) ) ) );
}
...
{
    return Quat( vec_madd( mVec128, scalar.get128(), (vec_float4)(0.0f) ) );
}
...
inline const Quat normalize( Quat quat )
{
    ...
    return Quat( vec_madd( quat.get128(), rsqrtf4( dot ), (vec_float4)(0.0f) ) );
}
...
inline const Quat Quat::rotation( Vector3 unitVec0, Vector3 unitVec1 )
{
    ...
    res = vec_madd( crossVec.get128(), recipCosHalfAngleX2, (vec_float4)(0.0f) );
...
inline const Quat Quat::rotation( floatInVec radians, Vector3 unitVec )
{
    ...
    angle = vec_madd( radians.get128(), (vec_float4)(0.5f), (vec_float4)(0.0f) );
    sincosf4( angle, &s, &c );
    res = vec_sel( vec_madd( unitVec.get128(), s, (vec_float4)(0.0f) ), c, _VECTORMATH_MASK_0x000F );
    return Quat( res );
}
