...
#define GL_BUFFER_PITCH_SCE 0x6041
    ...
    GLAPI void APIENTRY glDeleteEventsSCE( GLsizei n, const GLuint *fences );
    GLAPI void APIENTRY glGenEventsSCE( GLsizei n, GLuint *fences );
...
#define GL_PUSHSTRINGMARKER 1
    GLAPI void APIENTRY glPushStringMarkerSCE( const GLubyte* );
    GLAPI void APIENTRY glPopStringMarkerSCE( void );
