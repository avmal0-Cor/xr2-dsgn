 ...
 */
  ...
  #define _NO_MT	1
  #define _NO_EX	1
  #define _HAS_C9X	1 /* Include all C9X routines. */
 #endif
  ...
  #define _FPP_TYPE     _FPP_SPU
  #define _INTPTR       0       /* "size_t" is defined as "unsigned long" in sys/types.h */
...
/* Inline definitions are only supported in C99 or C++. */
  ...
  #define _INLINE_DEF
 #elif defined(__OPTIMIZE__) && ((defined(__STDC_VERSION__) && 199901L <= __STDC_VERSION__) || defined(__cplusplus))
  #ifdef __GNUC__
...
#define _FBIAS	0x7e
#define _FOFF	7
#define _FRND	1	/* round to nearest */
#define _FEVAL  0 	/* no promotion */
