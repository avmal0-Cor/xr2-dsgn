...
#define _VECTORMATH_SHUF_XAAX ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_A, _VECTORMATH_SHUF_A, _VECTORMATH_SHUF_X })
#define _VECTORMATH_SHUF_XXAA ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_A, _VECTORMATH_SHUF_A })
#define _VECTORMATH_SHUF_WDDW ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_W, _VECTORMATH_SHUF_D, _VECTORMATH_SHUF_D, _VECTORMATH_SHUF_W })
#define _VECTORMATH_SHUF_WWDD ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_W, _VECTORMATH_SHUF_W, _VECTORMATH_SHUF_D, _VECTORMATH_SHUF_D })
#define _VECTORMATH_SHUF_YXBA ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_B, _VECTORMATH_SHUF_A })
#define _VECTORMATH_SHUF_WZDC ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_W, _VECTORMATH_SHUF_Z, _VECTORMATH_SHUF_D, _VECTORMATH_SHUF_C })
#define _VECTORMATH_SHUF_YBBY ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_B, _VECTORMATH_SHUF_B, _VECTORMATH_SHUF_Y })
#define _VECTORMATH_SHUF_YYBB ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_B, _VECTORMATH_SHUF_B })
#define _VECTORMATH_SHUF_WCDZ ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_W, _VECTORMATH_SHUF_C, _VECTORMATH_SHUF_D, _VECTORMATH_SHUF_Z })
#define _VECTORMATH_SHUF_YABX ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_A, _VECTORMATH_SHUF_B, _VECTORMATH_SHUF_X })
#define _VECTORMATH_SHUF_ZBWX ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Z, _VECTORMATH_SHUF_B, _VECTORMATH_SHUF_W, _VECTORMATH_SHUF_X })
#define _VECTORMATH_SHUF_XYAX ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_A, _VECTORMATH_SHUF_X })
#define _VECTORMATH_SHUF_ZWBX ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Z, _VECTORMATH_SHUF_W, _VECTORMATH_SHUF_B, _VECTORMATH_SHUF_X })
#define _VECTORMATH_SHUF_XXXX ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_X, _VECTORMATH_SHUF_X })
#define _VECTORMATH_SHUF_YYYY ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_Y, _VECTORMATH_SHUF_Y })
#define _VECTORMATH_SHUF_ZZZZ ((vec_uchar16)(vec_uint4){ _VECTORMATH_SHUF_Z, _VECTORMATH_SHUF_Z, _VECTORMATH_SHUF_Z, _VECTORMATH_SHUF_Z })
...
inline const Matrix4 inverse( const Matrix4 & mat )
{
    ...
    vec_float4 inA0 = spu_shuffle(in0, in1, _VECTORMATH_SHUF_XAYB); // ABEF
    vec_float4 inA1 = spu_shuffle(in2, in3, _VECTORMATH_SHUF_XAYB); // CDGH
    vec_float4 inA2 = spu_shuffle(in0, in1, _VECTORMATH_SHUF_ZCWD); // IJMN
    vec_float4 inA3 = spu_shuffle(in2, in3, _VECTORMATH_SHUF_ZCWD); // KLOP
    
    // XYZW, ABCD
    vec_float4 KIIK = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_XAAX); // KLOP, IJMN
    vec_float4 KKII = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_XXAA); // KLOP, IJMN
    vec_float4 NPPN = spu_shuffle(in1, in3, _VECTORMATH_SHUF_WDDW); // BFJN,DHLP
    vec_float4 PPNN = spu_shuffle(in3, in1, _VECTORMATH_SHUF_WWDD); // DHLP,BFJN
    vec_float4 OMMO = spu_shuffle(in2, in0, _VECTORMATH_SHUF_WDDW); // CGKO,AEIM
    vec_float4 OOMM = spu_shuffle(in2, in0, _VECTORMATH_SHUF_WWDD); // CGKO,AEIM
    vec_float4 JILK = spu_shuffle(inA2, inA3, _VECTORMATH_SHUF_YXBA); // IJMN,KLOP
    vec_float4 LKJI = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_YXBA); // KLOP,IJMN
    vec_float4 PONM = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_WZDC); // KLOP,IJMN
    vec_float4 NMPO = spu_shuffle(inA2, inA3, _VECTORMATH_SHUF_WZDC); // IJMN,KLOP
    vec_float4 JLLJ = spu_shuffle(inA2, inA3, _VECTORMATH_SHUF_YBBY); // IJMN, KLOP
    vec_float4 LLJJ = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_YYBB); // KLOP,IJMN
    vec_float4 CAAC = spu_shuffle(in2, in0, _VECTORMATH_SHUF_XAAX); // CGKO,AEIM
    vec_float4 CCAA = spu_shuffle(in2, in0, _VECTORMATH_SHUF_XXAA); // CGKO,AEIM
    vec_float4 GEEG = spu_shuffle(in2, in0, _VECTORMATH_SHUF_YBBY); // CGKO,AEIM
    vec_float4 GGEE = spu_shuffle(in2, in0, _VECTORMATH_SHUF_YYBB); // CGKO,AEIM
    vec_float4 BADC = spu_shuffle(inA0, inA1, _VECTORMATH_SHUF_YXBA); // ABEF,CDGH
    vec_float4 DCBA = spu_shuffle(inA1, inA0, _VECTORMATH_SHUF_YXBA); // CDGH,ABEF
    vec_float4 HGFE = spu_shuffle(inA1, inA0, _VECTORMATH_SHUF_WZDC); // CDGH,ABEF
    vec_float4 FEHG = spu_shuffle(inA0, inA1, _VECTORMATH_SHUF_WZDC); // ABEF,CDGH
    vec_float4 FHHF = spu_shuffle(inA0, inA1, _VECTORMATH_SHUF_WDDW); // ABEF, CDGH
    vec_float4 HHFF = spu_shuffle(inA1, inA0, _VECTORMATH_SHUF_WWDD); // CDGH,ABEF
    vec_float4 BDDB = spu_shuffle(in1, in3, _VECTORMATH_SHUF_XAAX); // BFJN,DHLP
    vec_float4 DDBB = spu_shuffle(in3, in1, _VECTORMATH_SHUF_XXAA); // DHLP,BFJN
    
    vec_float4 KP__IP__IN__KN = spu_mul(KIIK, PPNN);
    vec_float4 JP__IO__LN__KM = spu_mul(JILK, PONM);
    vec_float4 KN__KP__IP__IN = spu_mul(KKII, NPPN);
    vec_float4 CH__AH__AF__CF = spu_mul(CAAC, HHFF);
    vec_float4 BH__AG__DF__CE = spu_mul(BADC, HGFE);
    vec_float4 CF__CH__AH__AF = spu_mul(CCAA, FHHF);
    
    vec_float4 FGHE = spu_shuffle(inA0, inA1, _VECTORMATH_SHUF_WCDZ); // ABEF,CDGH
    vec_float4 GHEF = spu_shuffle(inA1, inA0, _VECTORMATH_SHUF_ZWCD); // CDGH,ABEF
    vec_float4 HEFG = spu_shuffle(inA1, inA0, _VECTORMATH_SHUF_WCDZ); // CDGH,ABEF
    vec_float4 BCDA = spu_shuffle(inA0, inA1, _VECTORMATH_SHUF_YABX); // ABEF,CDGH
    vec_float4 CDAB = spu_shuffle(inA1, inA0, _VECTORMATH_SHUF_XYAB); // CDGH,ABEF
    vec_float4 DABC = spu_shuffle(inA1, inA0, _VECTORMATH_SHUF_YABX); // CDGH,ABEF
    vec_float4 NOPM = spu_shuffle(inA2, inA3, _VECTORMATH_SHUF_WCDZ); // IJMN,KLOP
    vec_float4 OPMN = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_ZWCD); // KLOP,IJMN
    vec_float4 PMNO = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_WCDZ); // KLOP,IJMN
    vec_float4 JKLI = spu_shuffle(inA2, inA3, _VECTORMATH_SHUF_YABX); // IJMN,KLOP
    vec_float4 KLIJ = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_XYAB); // KLOP,IJMN
    vec_float4 LIJK = spu_shuffle(inA3, inA2, _VECTORMATH_SHUF_YABX); // KLOP,IJMN
    
    vec_float4 KP_LO__IP_LM__IN_JM__KN_JO = spu_nmsub(LLJJ, OMMO, KP__IP__IN__KN);
    vec_float4 JP_LN__IO_KM__LN_JP__KM_IO = spu_nmsub(LKJI, NMPO, JP__IO__LN__KM);
    vec_float4 KN_JO__KP_LO__IP_LM__IN_JM = spu_nmsub(JLLJ, OOMM, KN__KP__IP__IN);
    vec_float4 CH_DG__AH_DE__AF_BE__CF_BG = spu_nmsub(DDBB, GEEG, CH__AH__AF__CF);
    vec_float4 BH_DF__AG_CE__DF_BH__CE_AG = spu_nmsub(DCBA, FEHG, BH__AG__DF__CE);
    vec_float4 CF_BG__CH_DG__AH_DE__AF_BE = spu_nmsub(BDDB, GGEE, CF__CH__AH__AF);
    
    vec_float4 tmpA1 = spu_mul(FGHE, KP_LO__IP_LM__IN_JM__KN_JO);
    vec_float4 tmpB1 = spu_nmsub(GHEF, JP_LN__IO_KM__LN_JP__KM_IO, tmpA1);
    vec_float4 out1 = spu_nmsub(HEFG, KN_JO__KP_LO__IP_LM__IN_JM, tmpB1);
    vec_float4 tmpB2 = spu_mul(CDAB, JP_LN__IO_KM__LN_JP__KM_IO);
    vec_float4 tmpA2 = spu_nmsub(BCDA, KP_LO__IP_LM__IN_JM__KN_JO, tmpB2);
    vec_float4 out2 = spu_madd(DABC, KN_JO__KP_LO__IP_LM__IN_JM, tmpA2);
    vec_float4 tmpA3 = spu_mul(NOPM, CH_DG__AH_DE__AF_BE__CF_BG);
    vec_float4 tmpB3 = spu_nmsub(OPMN, BH_DF__AG_CE__DF_BH__CE_AG, tmpA3);
    vec_float4 out3 = spu_nmsub(PMNO, CF_BG__CH_DG__AH_DE__AF_BE, tmpB3);
    vec_float4 tmpB4 = spu_mul(KLIJ, BH_DF__AG_CE__DF_BH__CE_AG);
    vec_float4 tmpA4 = spu_nmsub(JKLI, CH_DG__AH_DE__AF_BE__CF_BG, tmpB4);
    vec_float4 out4 = spu_madd(LIJK, CF_BG__CH_DG__AH_DE__AF_BE, tmpA4);
    
    //det
    vec_float4 AF_BE__AG_CE__CF_BG__AF_BE =
        spu_shuffle(CH_DG__AH_DE__AF_BE__CF_BG, BH_DF__AG_CE__DF_BH__CE_AG, _VECTORMATH_SHUF_ZBWX);
    vec_float4 KP_LO__JP_LN__IP_LM__IO_KM =
        spu_shuffle(KP_LO__IP_LM__IN_JM__KN_JO, JP_LN__IO_KM__LN_JP__KM_IO, _VECTORMATH_SHUF_XAYB);
    vec_float4 CH_DG__AH_DE__BH_DF__CH_DG =
        spu_shuffle(CH_DG__AH_DE__AF_BE__CF_BG, BH_DF__AG_CE__DF_BH__CE_AG, _VECTORMATH_SHUF_XYAX);
    vec_float4 IN_JM__KN_JO__IO_KM__IN_JM =
        spu_shuffle(KP_LO__IP_LM__IN_JM__KN_JO, JP_LN__IO_KM__LN_JP__KM_IO, _VECTORMATH_SHUF_ZWBX);
    vec_float4 det0 = spu_mul(AF_BE__AG_CE__CF_BG__AF_BE, KP_LO__JP_LN__IP_LM__IO_KM);
    vec_float4 det1 = spu_madd(CH_DG__AH_DE__BH_DF__CH_DG, IN_JM__KN_JO__IO_KM__IN_JM, det0);
    vec_float4 detA0 = spu_shuffle(det1, det1, _VECTORMATH_SHUF_XXXX);
    vec_float4 detA1 = spu_shuffle(det1, det1, _VECTORMATH_SHUF_YYYY);
    vec_float4 detA2 = spu_shuffle(det1, det1, _VECTORMATH_SHUF_ZZZZ);
    vec_float4 detB0 = spu_sub(detA0, detA1);
    vec_float4 det = spu_sub(detB0, detA2);
    vec_float4 y0 = spu_re(det);
    vec_float4 invdet = spu_madd(spu_nmsub(det, y0, (vec_float4)(1.0f) ), y0, y0);
    #else
    ...
    vec_float4 out1, out2, out3, out4;
    ...
    out1 = spu_mul(t1, t23);                      /* JGP NCL BOH FKD */
    out2 = spu_mul(t0, t23);                      /* AGP ECL IOH MKD */
    t23r = spu_rlqwbyte(t23, 8);                  /* OH KD GP CL */
    out1 = spu_msub(t1, t23r, out1);              /* JOH NKD BGP FCL  - out1 */
    out2 = spu_msub(t0, t23r, out2);              /* AOH EKD IGP MCL  - out2 */
    out2 = spu_rlqwbyte(out2, 8);                 /* IGP MCL AOH EKD - IOH MKD AGP ECL */

    t12 = spu_mul(t1, t2);                        /* JC NG BK FO */
    t12 = spu_shuffle(t12, t12, _VECTORMATH_SHUF_YXWZ);     /* NG JC FO BK */
    out1 = spu_madd(t3, t12, out1);               /* LNG PJC DFO HBK + out1 */
    out4 = spu_mul(t0, t12);                      /* ANG EJC IFO MBK */
    t12r = spu_rlqwbyte(t12, 8);                  /* FO BK NG JC */
    out1 = spu_nmsub(t3, t12r, out1);             /* out1 - LFO PBK DNG HJC */
    out4 = spu_msub(t0, t12r, out4);              /* AFO EBK ING MJC - out4 */
    out4 = spu_rlqwbyte(out4, 8);                 /* ING MJC AFO EBK - IFO MBK ANG EJC */
    ...
    out1 = spu_madd(t2r, t1r3, out1);             /* KFP OBL CNH GJD + out1 */
    out3 = spu_mul(t0, t1r3);                     /* AFP EBL INH MJD */
    t1r3r = spu_rlqwbyte(t1r3, 8);                /* NH JD FP BL */
    out1 = spu_nmsub(t2r, t1r3r, out1);           /* out1 - KNH OJD CFP GBL */
    out3 = spu_msub(t0, t1r3r, out3);             /* ANH EJD IFP MBL - out3 */
    out3 = spu_rlqwbyte(out3, 8);                 /* IFP MBL ANH EJD - INH MJD AFP EBL */
    t01 = spu_mul(t0, t1);                                /* AJ EN IB MF */
    t01 = spu_shuffle(t01, t01, _VECTORMATH_SHUF_YXWZ);     /* EN AJ MF IB */
    out3 = spu_madd(t3, t01, out3);               /* LEN PAJ DMF HIB + out3 */
    out4 = spu_msub(t2r, t01, out4);              /* KEN OAJ CMF GIB - out4 */
    t01r = spu_rlqwbyte(t01, 8);                  /* MF IB EN AJ */
    out3 = spu_msub(t3, t01r, out3);              /* LMF PIB DEN HAJ - out3 */
    out4 = spu_nmsub(t2r, t01r, out4);            /* out4 - KMF OIB CEN GAJ */
    t03 = spu_mul(t0, t3);                                /* AL EP ID MH */
    t03 = spu_shuffle(t03, t03, _VECTORMATH_SHUF_YXWZ);     /* EP AL MH ID */
    out2 = spu_nmsub(t2r, t03, out2);             /* out2 - KEP OAL CMH GID */
    out3 = spu_madd(t1, t03, out3);               /* JEP NAL BMH FID + out3 */
    t03r = spu_rlqwbyte(t03, 8);                  /* MH ID EP AL */
    out2 = spu_madd(t2r, t03r, out2);             /* KMH OID CEP GAL + out2 */
    out3 = spu_nmsub(t1, t03r, out3);             /* out3 - JMH NID BEP FAL */
    t02 = spu_mul(t0, t2r);                       /* AK EO IC MG */
    t02 = spu_shuffle(t02, t02, _VECTORMATH_SHUF_YXWZ);     /* E0 AK MG IC */
    out2 = spu_madd(t3, t02, out2);               /* LEO PAK DMG HIC + out2 */
    out4 = spu_nmsub(t1, t02, out4);              /* out4 - JEO NAK BMG FIC */
    t02r = spu_rlqwbyte(t02, 8);                  /* MG IC EO AK */
    out2 = spu_nmsub(t3, t02r, out2);             /* out2 - LMG PIC DEO HAK */
    out4 = spu_madd(t1, t02r, out4);              /* JMG NIC BEO FAK + out4 */
    ...
    #endif
    return Matrix4(
        Vector4( spu_mul(out1, invdet) ),
        Vector4( spu_mul(out2, invdet) ),
        Vector4( spu_mul(out3, invdet) ),
        Vector4( spu_mul(out4, invdet) )
    );
}
...
inline const Vector4 Matrix4::operator *( Point3 pnt ) const
{
    ...
    tmp0 = spu_mul( mCol0.get128(), xxxx );
    tmp1 = spu_madd( mCol1.get128(), yyyy, mCol3.get128() );
    tmp0 = spu_madd( mCol2.get128(), zzzz, tmp0 );
    res = spu_add( tmp0, tmp1 );
    return Vector4( res );
}
