...
#ifndef _VECTORMATH_PRINTF_HEADER
#define _VECTORMATH_PRINTF_HEADER <spu_printf.h>
#endif
#include _VECTORMATH_PRINTF_HEADER
#endif
...
// Load eight three-half-floats as 3-D vectors
// NOTE: 
...
// Load four four-half-floats as 4-D vectors
// NOTE: 
// This transformation does not support either denormalized numbers or NaNs.
// 
...
// Load eight three-half-floats as 3-D points
// NOTE: 
// This transformation does not support either denormalized numbers or NaNs.
// 
inline void loadHalfFloats( Point3 & pnt0, Point3 & pnt1, Point3 & pnt2, Point3 & pnt3, Point3 & pnt4, Point3 & pnt5, Point3 & pnt6, Point3 & pnt7, const vec_ushort8 * threeQuads );

// Load three half-floats as a 3-D point
// NOTE: 
// This transformation does not support either denormalized numbers or NaNs.
// 
inline void loadHalfFloats( Point3 & pnt, const uint16_t * hfptr );
...
// This transformation does not support either denormalized numbers or NaNs. Memory area of previous 16 bytes and next 32 bytes from hfptr might be accessed.
// 
inline void storeHalfFloats( Point3 pnt, uint16_t * hfptr );
