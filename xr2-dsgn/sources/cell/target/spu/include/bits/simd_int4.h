...
int4::int4( bool4 rhs )
{
   data = (vec_int4)spu_and( (vec_uint4)rhs, 1 );
}
...
{
   return (int)spu_extract((vec_int4)data, i);
}
...
int4::operator - () const
{
   return int4( (vec_int4)spu_sub( (int)0, data ) );
}
...
{
   vec_short8 lhs_short = (vec_short8)(vec_int4)lhs;
   vec_short8 rhs_short = (vec_short8)(vec_int4)rhs;
   
   return int4( (vec_int4)spu_add( spu_add( spu_mulh( lhs_short, rhs_short ),
...
operator >> ( int4 lhs, uint4 rhs )
{
   return int4( spu_rlmaska( (vec_int4)lhs, (vec_int4)-rhs ) );
}
...
{
   bool4 result;
   result.data = spu_cmpgt( (vec_int4)rhs, (vec_int4)lhs );
   return result;
}
...
{
   bool4 result;
   result.data = spu_cmpgt( (vec_int4)lhs, (vec_int4)rhs );
   return result;
}
...
{
   bool4 result;
   result.data = spu_cmpeq( (vec_int4)lhs, (vec_int4)rhs );
   return result;
}
...
{
   ref = spu_insert( (int)rhs, (vec_int4)ref, i );
   return rhs;
}
...
{
   int tmp = spu_extract( (vec_int4)ref, i );
   ref = spu_insert( tmp+1, (vec_int4)ref, i );
   return tmp;
}
...
int4_idx::operator ++()
{
   int tmp = spu_extract( (vec_int4)ref, i );
   ++tmp;
   ref = spu_insert( tmp, (vec_int4)ref, i );
   return tmp;
}
...
int4_idx::operator *= ( int rhs )
{
   int tmp = spu_extract( (vec_int4)ref, i ) * rhs;
   ref = spu_insert( tmp, (vec_int4)ref, i );
   return tmp;
}
