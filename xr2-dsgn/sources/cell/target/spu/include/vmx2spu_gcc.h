...
#ifndef _VMX2SPU_GCC_H_
#define _VMX2SPU_GCC_H_	1
...
static inline vec_short8 vec_abss(vec_short8 a)
{
  ...
  minus_a = spu_add(spu_sub(0, a), (vec_short8)(spu_cmpeq(a, (vec_short8)(0x8000))));
  return (spu_sel(minus_a, a, spu_cmpgt(a, -1)));
}
...
static inline vec_int4 vec_abss(vec_int4 a)
{
  ...
  minus_a = spu_add(spu_sub(0, a), (vec_int4)(spu_cmpeq(a, (vec_int4)(0x80000000))));
  return (spu_sel(minus_a, a, spu_cmpgt(a, -1)));
}
