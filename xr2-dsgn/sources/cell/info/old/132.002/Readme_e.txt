...
Please make sure to read them.
  ...
  - Important_Changes: SDK132 new features,chages,notes
...
(*) The same document as SDK 131 is used since no change is made.
...
As for the Toolchain packages, please use the packages released 
in ToolChain131. 
...
released in SDK093. 
     ...
     PS3_SDK_SampleData-132_002.zip    Sample Data 
     PS3_Toolchain-Win_131_002.zip     gcc/gdb Windows
     PS3_Toolchain-Linux_131_002.zip   gcc/gdb Linux
     PS3_SDKDoc-131_01-Latest-*.zip    Documents
...
- Please note that the operation of when updated directly 
  from the environment of SDK100 or before to SDK132 is not guaranteed. 
