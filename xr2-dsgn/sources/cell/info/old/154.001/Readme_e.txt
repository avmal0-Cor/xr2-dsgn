...
Please make sure to read them.
  ...
  - Important_Changes: SDK154 new features,chages,notes
...
(*) The same document as SDK 150 is used since no change is made.
...
to download the following packages that are provided in separate packages. 
     ...
     PS3_SDK_SampleData-154_001.zip    Sample Data 
     PS3_Toolchain-Win_150_004.zip     gcc/gdb Windows
     PS3_Toolchain-Linux_150_004.zip   gcc/gdb Linux
     PS3_SDKDoc-154_01-Latest-*.zip    Documents
     PS3_SDKDoc-154_01-(patch_from_150_01)-*.zip  Patch Document
     PS3_Generator-110.zip             Disc Image Generator
...
- Please note that the operation of when updated directly 
  from the environment of SDK100 or before to SDK154 is not guaranteed. 
