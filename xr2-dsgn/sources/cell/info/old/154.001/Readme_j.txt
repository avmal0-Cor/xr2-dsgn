...
infoディレクトリ内に以下のものが含まれますので、必ず参照してください。
  ...
  - ソフトウェアセットアップガイド (*)
  - Important_Changes： SDK154の新規機能、変更点、注意事項
  - Notice: 既知の不具合、制限事項
  - Bugfix: 不具合修正
  - PLAYSTATION(R)3 FAQ (*)
  - Referenceシステム 活用ガイド (*)
...
(*) 内容の変更がありませんので、SDK150のドキュメントと同じファイルと
    なります。
...
提供している以下のパッケージを必ずダウンロードしてください。
     ...
     PS3_Toolchain-Win_150_004.zip     gcc/gdb Windows版
     PS3_Toolchain-Linux_150_004.zip   gcc/gdb Linux版
     PS3_SDKDoc-154_01-Latest-*.zip    ドキュメント
     PS3_SDKDoc-154_01-(patch_from_150_01)-*.zip  パッチドキュメント
...
- SDK100以前の環境から直接SDK154へアップデートした場合の動作についての
  保障はいたしませんので、ご注意ください。
