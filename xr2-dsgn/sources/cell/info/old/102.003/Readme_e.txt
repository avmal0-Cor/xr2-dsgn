...
This package includes the SDK102.002 package, a following bug 
has been fixed.
----------------------------------------------------------------------
System Utilities (libsysutil)
----------------------------------------------------------------------
<Audio Setting Utility>
- With cellAudioOutGetSoundAvailability() and cellAudioOutGetDeviceInfo(),
  the information of audio output setting could not be obtained correctly 
...
Please make sure to read them.
  ...
  - Important_Changes: SDK102.002 new features,chages,notes
  - Notice: known bugs, and limitations in SDK102.002
  - Bugfix: bug fix in SDK102.002
  - PLAYSTATION(R)3 FAQ   (*)
...
(*) The same document as SDK 101 is used since no change is made.
...
In SDK102, the packages other than the Documents package are not updated. 
As for the Reference Tool CP update file package, please use the package
released in SDK094. 
...
released in SDK093. 
     ...
     PS3_Toolchain-Win_102_002.zip     gcc/gdb Windows
     PS3_Toolchain-Linux_102_002.zip   gcc/gdb Linux
     PS3_SDKDoc-102_01-Latest-*.zip    Documents
     PS3_SDKDoc-102_01-(patch_from_101_01)-*.zip  Patch Document
