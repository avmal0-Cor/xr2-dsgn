...
必ず参照してください。
  ...
  [cell\info\以下のドキュメント]
   - Important_Changes： SDK310の新規機能、変更点、注意事項
   - Notice: 既知の不具合、制限事項
   - Bugfix: 不具合修正

  [cell\info\old\XXX 以下のドキュメント]  (XXX:SDKリリースバージョン)
   - SDK300以前にリリースしたSDKリリースバージョン毎の変更点に関するファイル
...
提供している以下のパッケージを必ずダウンロードしてください。
  ...
  ==========================
     ...
     PS3DECRUpdateData.310.001.zip              Reference Tool用アップデートデータ
     PS3_SDKDoc-310_01-Latest-*.zip             ドキュメント
...
- SDK100以前の環境から直接SDK310へアップデートした場合の動作についての
  保障はいたしませんので、ご注意ください。
