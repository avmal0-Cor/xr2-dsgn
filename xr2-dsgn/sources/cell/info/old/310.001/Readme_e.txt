...
Please make sure to read them.
  ...
  [Documents under cell\info\]
   - Important_Changes: SDK310 new features,chages,notes
   - Notice: known bugs, and limitations
   - Bugfix: bug fix

  [Documents under cell\info\old\XXX]  (XXX:SDK release version)
   - The following files in each SDKXXX release version, in SDK300 and before.
  ...
  (*) Contents have not been changed from the SDK300 documents.
...
to download the following packages that are provided in separate packages. 
  ...
  ===============
     ...
     PS3DECRUpdateData.310.001.zip              Update data for Reference Tool
     PS3_SDKDoc-310_01-Latest-*.zip             Documents
  ...
  - Graphics:
      ...
      PS3_GPAD-SDK300.2_8.3_Installer.zip       GPAD
   ...
   - Sound:
      ...
      MultiStream_Tools-140.zip         MultiStream Tools
  ...
  Creating Disc
  =============
     PS3_Generator_Tools-250.zip        Disc Image Generator Tools
     PS3_Checker-250.zip                Disc Image Checker
...
- Please note that the operation of when updated directly 
  from the environment of SDK100 or before to SDK310 is not guaranteed. 
