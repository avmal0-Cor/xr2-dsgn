...
パッケージには、以下のコンポーネントは含まれません。
  - COLLADA_Pipeline
  - Performance Analyzer Tools  (近日中にリリース致します)
  - PAMF Tools  (近日中にリリース致します)

infoディレクトリ内に以下のものが含まれますので、必ず参照してください。
今回、PLAYSTATION(R)3 Debugging Station ソフトウェアセットアップガイドを
新規に追加しました。

  - ソフトウェアセットアップガイド
  - Important_Changes： SDK180の新規機能、変更点、注意事項
  - Notice: 既知の不具合、制限事項
  - Bugfix: 不具合修正
  - Referenceシステム 活用ガイド
...
(*) 内容の変更がありませんので、SDK170のドキュメントと同じファイルと
    なります。
...
提供している以下のパッケージを必ずダウンロードしてください。
     ...
     PS3_SDK_SCREAM-180_002.zip        SCREAM Runtime Library
...
- SDK100以前の環境から直接SDK180へアップデートした場合の動作についての
  保障はいたしませんので、ご注意ください。
