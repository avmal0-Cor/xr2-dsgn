...
Please make sure to read them.
  ...
  - Important_Changes: SDK101 new features,chages,notes
...
(*) The same document as SDK 100 is used since no change is made.
...
In SDK101, the packages other than the Documents package are not updated. 
...
released in SDK093. 
     ...
     PS3_SDKDoc-101_01-Latest-*.zip    Documents
     PS3_SDKDoc-101_01-(patch_from_100_01)-*.zip  Patch Document
