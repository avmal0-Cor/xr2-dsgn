...
Please make sure to read them.
  ...
  - Important_Changes: SDK131 new features,chages,notes
...
(*) The same document as SDK 110 is used since no change is made.
...
In SDK131, the packages other than the Documents package are not updated. 
...
- Please note that the operation of when updated directly 
  from the environment of SDK100 or before to SDK130 is not guaranteed. 
