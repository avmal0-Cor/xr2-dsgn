...
The following component is not included. 
  - COLLADA_DOM
  - SCREAM Runtime Library for SDK181  (This will be released soon.)

The following are included in the info directory. 
Please make sure to read them.
In this release, the Important_Changes_* document is not included 
because there are no new features or changes. 
  ...
  - text/ : The text files of Notice and Bugfix

(*) The same document as SDK 180 is used since no change is made.
...
to download the following packages that are provided in separate packages. 
     ...
     PS3_SDK_SampleData-181_001.zip    Sample Data 
     ...
     PS3_PA_180_002.zip                Performance Analyzer Tools
...
- Please note that the operation of when updated directly 
  from the environment of SDK100 or before to SDK181 is not guaranteed. 
